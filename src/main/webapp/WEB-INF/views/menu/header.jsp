...
<div  id="filter">
	<div class="container">
		<div class="checkbox col-sm-12 text-center">
			...
			</label> <label class="col-sm-2"> <input id="parking" type="checkbox"
				data-toggle="toggle" data-onstyle="success"><b>주차장</b>&nbsp;&nbsp;
			</label> <label class="col-sm-2"> <input id="singing" type="checkbox"
				data-toggle="toggle" data-onstyle="success"><b>노래방</b>&nbsp;&nbsp;
			</label> <label class="col-sm-2"> <input id="football" type="checkbox"
				data-toggle="toggle" data-onstyle="success"><b>족구장</b>&nbsp;&nbsp;
			</label> <label class="col-sm-2"> <input id="pickup" type="checkbox"
				data-toggle="toggle" data-onstyle="success"><b>픽업</b>
			</label>
		</div>
		<script>
			$('#bbq').change(function() {
