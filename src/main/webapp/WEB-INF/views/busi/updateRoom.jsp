				...
				<div class="row-fluid">
					...
					<div class="block">
						...
						<div class="block-content collapse in">
							<div class="span12">
								<form role="form"  class="form-horizontal" action="${pageContext.request.contextPath}/busi/pension/updateRoom.do" method="post" enctype="multipart/form-data" onsubmit="return doWrite()" name="writeForm"> 
									<fieldset>
										...
										<div class="control-group">
											...
											<div class="controls">
												<input class="input-xlarge focused" type="text" name="roomName" value="${roomVO.roomName }">
											</div>
										</div>
										<div class="control-group">
											<label class="control-label">객실형태</label>
											<div class="controls">
												<input class="input-xlarge focused" type="text" name="style" value="${roomVO.style }">
											</div>
										</div>
										<div class="control-group">
											<label class="control-label">객실크기</label>
											<div class="controls">
												<input class="input-xlarge focused" type="text" placeholder="00평" name="roomSize" value="${roomVO.roomSize }">
											</div>
										</div>
										<div class="control-group">
											<label class="control-label">*기준인원</label>
											<div class="controls">
												<input class="input-xlarge focused" type="number" value="${roomVO.personMin }" name="personMin">
											</div>
										</div>
										<div class="control-group">
											<label class="control-label">*최대인원</label>
											<div class="controls">
												<input class="input-xlarge focused" type="number" value="${roomVO.personMax }" name="personMax">
											</div>
										</div>
										<div class="control-group">
											<label class="control-label">성수기 주중 가격</label>
											<div class="controls">
												<input class="input-xlarge focused" type="text" placeholder="숫자만 입력하세요" name="hWeekPrice" value="${roomVO.hWeekPrice }">
											</div>
										</div>
										<div class="control-group">
											<label class="control-label">성수기 주말 가격</label>
											<div class="controls">
												<input class="input-xlarge focused" type="text" placeholder="숫자만 입력하세요" name="hWeekendPrice" value="${roomVO.hWeekendPrice }">
											</div>
										</div>
										<div class="control-group">
											<label class="control-label">비수기 주중 가격</label>
											<div class="controls">
												<input class="input-xlarge focused" type="text" placeholder="숫자만 입력하세요" name="nWeekPrice" value="${roomVO.nWeekPrice }">
											</div>
										</div>
										<div class="control-group">
											<label class="control-label">비수기 주말 가격</label>
											<div class="controls">
												<input class="input-xlarge focused" type="text" placeholder="숫자만 입력하세요" name="nWeekendPrice" value="${roomVO.nWeekendPrice }">
											</div>
										</div>
										<div class="control-group">
											<label class="control-label">추가요금</label>
											<div class="controls">
												<input class="input-xlarge focused" type="text" placeholder="숫자만 입력하세요" name="overPrice" value="${roomVO.overPrice }">
											</div>
										</div>
                                        <div class="control-group">
										...
										<div class="control-group">
                                          ...
                                          <div class="controls">
                                            <textarea class="input-xlarge textarea" name="content" placeholder="Enter text ..." style="width: 810px; height: 200px">${roomVO.content }</textarea>
                                          </div>
                                        </div>
